...
class Vib(object):
    ...
    def alpha_slope(self, outfilename, disp_str, omega=0.0, gamma=0.1088j, states=0, gamma2=0.0, types=[]):
        if self.norm == 0.0:
        ...
        alpha_minus = out_minus.compute_alpha(omega, gamma, states, False, gamma2, types)
        alpha_plus  =  out_plus.compute_alpha(omega, gamma, states, False, gamma2, types)
